...
const people: Person[] = [
  ...
  { name: "Jackie Liu", role: "Master’s Student", institution: "University of Southern California", image: "/people/jackie-liu.png", bio: "Jackie Liu is a master’s student at the University of Southern California contributing to the project’s research and development work in science learning and AI-supported inquiry.", links: [{ label: "LinkedIn", href: "https://www.linkedin.com/in/jacky-liu-tiao/" }, { label: "University of Southern California", href: "https://www.usc.edu/" }] },
  { name: "Ivan Shishkin", role: "Undergraduate Researcher", institution: "UC Irvine", image: "/people/ivan-shishkin.png", bio: "Ivan Shishkin is a UC Irvine undergraduate researcher working on educational technology and AI literacy. His interests include building tools that help students engage with AI while retaining ownership of their thinking.", links: [{ label: "Personal website", href: "https://ivanshishkin.com/" }, { label: "LinkedIn", href: "https://www.linkedin.com/in/ivan-shishkin-dev" }] },
];
